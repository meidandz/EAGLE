...
def qwen2vl_inference(question, tokenizer):
    ...
    prompt = ("<|im_start|>system\nYou are an AI assistant specialized in processing pathological diagnosis Q&A pairs.I will provide you with a pathology diagnosis question and its corresponding answer. Please extract keywords from the following pathology description,paying special attention to medical terms and important concepts. Output Format: Present the extracted claims as a list in the following format: [claim1, claim2, claim3, ...]<|im_end|>\n"
...
def main(args):
    ...
    ans_name = f"{model}_20k_{args.name}_keys.jsonl"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--question-file", 
                        type=str, 
                        default="./playground/dpo_data/vllm_generate/matched_20k_Qwen2-VL-7B-Instruct_t0.3.jsonl")
    parser.add_argument("--ans-path", 
                        type=str, 
                        default="./playground/dpo_data/vllm_generate/")
