...
def get_args():
    ...
    parser.add_argument("--src", default="./playground/eval_data/path_vqa/gt/test_qa.pkl", type=str, required=False)
    parser.add_argument("--dst", default="./playground/eval_data/path_vqa/gt/", type=str, required=False)
